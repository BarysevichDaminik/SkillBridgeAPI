...
namespace SkillBridgeAPI.Migrations
{
    ...
    [Migration("20250227192942_UserAvatarNumberAndRatingAdded")]
    partial class UserAvatarNumberAndRatingAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "exchange_status_enum", new[] { "pending", "active", "completed", "cancelled", "disputed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "user_status_enum", new[] { "active", "inactive", "pending", "blocked" });
            ...
            modelBuilder.Entity("SkillBridgeAPI.Models.Skill", b =>
                {
                    b.Navigation("ExchangeSkillId1Navigations");

                    b.Navigation("ExchangeSkillId2Navigations");
